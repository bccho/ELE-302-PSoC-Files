 ...
 **************************************/
#define Counter_INIT_PERIOD_VALUE       9999u
#define Counter_INIT_COUNTER_VALUE      9999u
#if (Counter_UsingFixedFunction)
#define Counter_INIT_INTERRUPTS_MASK    ((0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_INIT_COMPARE_VALUE      9u
#define Counter_INIT_INTERRUPTS_MASK ((0u << Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        (0u << Counter_STATUS_CAPTURE_INT_EN_MASK_SHIFT) | \
...
#define Counter_DEFAULT_CAPTURE_MODE    (0u << Counter_CTRL_CAPMODE0_SHIFT)
#endif /* (Counter_UsingFixedFunction) */
