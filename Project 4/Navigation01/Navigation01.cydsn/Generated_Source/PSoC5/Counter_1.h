 ...
 **************************************/
#define Counter_1_INIT_PERIOD_VALUE       20000u
#define Counter_1_INIT_COUNTER_VALUE      20000u
#if (Counter_1_UsingFixedFunction)
#define Counter_1_INIT_INTERRUPTS_MASK    ((1u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
