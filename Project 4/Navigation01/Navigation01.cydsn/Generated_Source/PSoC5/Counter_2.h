 ...
 **************************************/
#define Counter_2_INIT_PERIOD_VALUE       10000u
#define Counter_2_INIT_COUNTER_VALUE      10000u
#if (Counter_2_UsingFixedFunction)
#define Counter_2_INIT_INTERRUPTS_MASK    ((1u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
 ...
 *************************************/
    ...
    ********************************/
    ...
    #define Counter_2_ONESHOT                (0x01u << Counter_2_ONESHOT_SHIFT)
    ...
    #define Counter_2_RT1_MASK             (0x03u << Counter_2_RT1_SHIFT)  /* Sync TC and CMP bit masks */
    #define Counter_2_SYNC                 (0x03u << Counter_2_RT1_SHIFT)
    #define Counter_2_SYNCDSI_SHIFT        0x00u
    #define Counter_2_SYNCDSI_MASK         (0x0Fu << Counter_2_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define Counter_2_SYNCDSI_EN           (0x0Fu << Counter_2_SYNCDSI_SHIFT) /* Sync all DSI inputs */
