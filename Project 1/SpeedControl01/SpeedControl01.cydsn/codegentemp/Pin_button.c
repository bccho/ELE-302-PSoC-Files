...
{
    uint8 staticBits = Pin_button_DR & ~Pin_button_MASK;
    Pin_button_DR = staticBits | ((value << Pin_button_SHIFT) & Pin_button_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pin_button_0, mode);
}
...
{
    return (Pin_button_PS & Pin_button_MASK) >> Pin_button_SHIFT;
}
...
{
    return (Pin_button_DR & Pin_button_MASK) >> Pin_button_SHIFT;
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
        return (Pin_button_INTSTAT & Pin_button_MASK) >> Pin_button_SHIFT;
    }
